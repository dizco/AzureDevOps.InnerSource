...
export class RepositoryStatusBadgePanel extends React.Component<{}, IPanelContentState> {
    ...
    public render(): React.JSX.Element {
        ...
        return (
            <div className="flex-grow">
                ...
                <div className="separator-line-top">
                    <p>Status badges are private and secured with a token that expires in {Math.floor((this.state.badgeJwt?.expiresInSeconds ?? 0) /(60*60*24))} days.</p>
                </div>
            </div>
        );
    }
